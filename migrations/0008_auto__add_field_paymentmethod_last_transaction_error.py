...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentMethod.last_transaction_error'
        db.add_column('samurai_client_python_paymentmethod', 'last_transaction_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentMethod.last_transaction_error'
        db.delete_column('samurai_client_python_paymentmethod', 'last_transaction_error')
