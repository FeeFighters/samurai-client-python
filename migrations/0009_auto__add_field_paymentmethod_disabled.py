...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PaymentMethod.disabled'
        db.add_column('samurai_client_python_paymentmethod', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PaymentMethod.disabled'
        db.delete_column('samurai_client_python_paymentmethod', 'disabled')
