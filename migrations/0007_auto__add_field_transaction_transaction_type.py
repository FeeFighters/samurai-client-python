...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Transaction.transaction_type'
        db.add_column('samurai_client_python_transaction', 'transaction_type', self.gf('django.db.models.fields.CharField')(default='aoeu', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Transaction.transaction_type'
        db.delete_column('samurai_client_python_transaction', 'transaction_type')
